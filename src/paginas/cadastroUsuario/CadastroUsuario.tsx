                  ...
                  fullWidth />
                    <TextField 
                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <MailOutlineSharpIcon className='icon-color'/>
                          </InputAdornment>
                        ),
                      }}
                      fullWidth />
                      ...
                      <TextField 
                        ...
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position="start">
                              <CameraAltSharpIcon className='icon-color'/>
                            </InputAdornment>
                          ),
                        }}
                        fullWidth />
                        ...
                        <TextField 
                          ...
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                                <AdminPanelSettingsSharpIcon className='icon-color'/>
                              </InputAdornment>
                            ),
                          }}
                        fullWidth />
                        ...
                        <TextField 
                          ...
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                                <BusinessSharpIcon className='icon-color'/>
                              </InputAdornment>
                            ),
                          }}
                        fullWidth />
                        ...
                        <TextField 
                          ...
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                                <LockSharpIcon className='icon-color'/>
                              </InputAdornment>
                            ),
                          }}
                        fullWidth />
